...
// //To import everything without having to specify each one:
...
// Importing greeting. It was exported as a default. So, no need to use {} to import it.
import greeting from './es2015modules';
console.log(greeting);