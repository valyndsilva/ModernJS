...
// VIc.Check for values
// console.log(set1.has(100)); //true
// console.log(set1.has(50 + 50)); //true
// console.log(set1.has({name: 'John'})); //false
// console.log({name: 'John'} === {name: 'John'});  //false because it's not a primitive value type but a reference object
// console.log('John' === 'John'); // true since it's a primitive value type of string

// VId.Delete from set
// set1.delete(100);
// console.log(set1);

// VIe.ITERATING THROUGH SETS
